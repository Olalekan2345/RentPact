  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M19.5 4.5v4.5H15" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function HelpIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      ...
      <path
        d="M9.6 9.4a2.4 2.4 0 1 1 3.1 2.35c-.75.28-1.2.86-1.2 1.6v.35"
        stroke="currentColor"
        strokeWidth="1.75"
        strokeLinecap="round"
      />
      <circle cx="11.5" cy="16.4" r="0.65" fill="currentColor" />
    </svg>
  );
}
...
export function MailIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      ...
      <path d="M4.5 7.5l7.5 5.5 7.5-5.5" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
