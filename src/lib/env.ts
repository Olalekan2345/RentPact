...
const envSchema = z.object({
  ...
  NEXT_PUBLIC_ARC_ARBITER_ADDRESS: optionalString(z.string().regex(/^0x[a-fA-F0-9]{40}$/)),
...
function validateEnv(): EnvValidationResult {
  const raw = {
    ...
    NEXT_PUBLIC_ARC_ARBITER_ADDRESS: process.env.NEXT_PUBLIC_ARC_ARBITER_ADDRESS,
